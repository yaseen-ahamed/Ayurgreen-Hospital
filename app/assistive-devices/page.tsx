...
import { pageData } from "@/data/rehab/assistive-devices";
import RehabPageClient from "@/components/pages/rehab/RehabPageClient";

export const metadata: Metadata = {
  title: "Assistive Devices | Ayurgreen Hospital",
  description: "Assessing, custom fitting, and training on wheelchairs, splints, orthotics, and communication aids to elevate daily function.",
  keywords: [
  ...
  alternates: {
    canonical: "https://ayurgreenhospital.com/assistive-devices",
  },
  openGraph: {
    type: "website",
    url: "https://ayurgreenhospital.com/assistive-devices",
    title: "Assistive Devices | Ayurgreen Hospital",
    description: "Assessing, custom fitting, and training on wheelchairs, splints, orthotics, and communication aids to elevate daily function.",
    images: [
      {
...
export default function AssistiveDevicesPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "MedicalWebPage",
        "@id": "https://ayurgreenhospital.com/assistive-devices#webpage",
        "url": "https://ayurgreenhospital.com/assistive-devices",
        "name": "Assistive Devices | Ayurgreen Hospital",
        "description": "Assessing, custom fitting, and training on wheelchairs, splints, orthotics, and communication aids to elevate daily function.",
        "about": {
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://ayurgreenhospital.com/assistive-devices#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Assistive Devices",
            "item": "https://ayurgreenhospital.com/assistive-devices",
          },
        ],
      },
      {
        "@type": "Service",
        "@id": "https://ayurgreenhospital.com/assistive-devices#service",
        "name": "Assistive Devices",
        "provider": {
          "@type": "Hospital",
          "name": "Ayurgreen Hospital",
