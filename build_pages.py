                    ...
                    <div class="ayur-hero-breadcrumb">
                        ...
                        <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-top: 32px;">
                            ...
                            <a href="https://wa.me/918080808080" target="_blank" class="main-cta">
                                ...
                                <span class="arrow-btn" style="background: transparent; padding: 0; display: inline-flex; align-items: center; justify-content: center;"><img src="Assets/whatsapp-icon-3953.png" alt="WhatsApp" style="width: 32px; height: 32px; object-fit: contain;"></span>
                            </a>
                        </div>
                    </div>
                </div>
