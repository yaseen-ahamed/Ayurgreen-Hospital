...
export const pageData: RehabPageData = {
  ...
  sidebarId: "respiratory-therapy",
  metaTitle: "Respiratory Therapy | Ayurgreen Hospital",
  metaDescription: "Restoring lung volumes, diaphragmatic training, clearing airways, and supporting recovery post-respiratory distress.",
  ...
  conditions: {
    sectionLabel: "RESPIRATORY CONDITIONS",
  ...
  faq: {
    ...
    items: [
    {
        ...
        "answer": "Our recovery protocol for Respiratory Therapy combines daily intensive rehabilitation therapies (robotic support and physical therapy) with personalized Ayurvedic nerve nourishment and systemic detoxification to accelerate functional gains."
    },
    {
