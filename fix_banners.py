...
# Wait! Different pages have different indentations! 
# Let's replace the block containing the closing tags.
import re
content = re.sub(
    r'(</a>\s*</div>\s*</div>\s*)(</div>\s*</div>)',
    r'\1    </div>\n            \2',
    content
)
